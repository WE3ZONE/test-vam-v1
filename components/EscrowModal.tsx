      ...
      <div className="fixed inset-x-4 top-1/2 -translate-y-1/2 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-[480px] bg-divar-surface border border-divar-border rounded-xl shadow-2xl z-[101] max-h-[90vh] overflow-y-auto">
        <div className="p-5 border-b border-divar-border flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={onClose} className="text-divar-muted hover:text-white"><i className="fa-solid fa-xmark text-lg" /></button>
          </div>
        </div>
        ...
        <div className="p-5">
          {step === 1 && (
            <>
              <div className="bg-divar-bg border border-divar-border rounded-lg p-4 mb-4 max-h-48 overflow-y-auto text-xs text-gray-300 leading-relaxed">
              ...
              <label className="flex items-start gap-3 cursor-pointer mb-5">
                ...
                <span className="text-xs text-gray-300">قوانین و شرایط معامله امن را مطالعه کردم و می‌پذیرم.</span>
              </label>
              <button
                onClick={() => setStep(2)}
                disabled={!agreed}
                className="w-full bg-brand-600 hover:bg-brand-500 disabled:bg-gray-700 disabled:text-gray-500 text-white py-3 rounded-lg font-bold transition"
              >
                مرحله بعد
              </button>
            </>
            ...
            <>
              <div className="space-y-3 mb-5">
                <div className="bg-divar-bg border border-divar-border rounded-lg p-4">
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div>
                      ...
                      <div className="text-white font-medium">{listing.bank}</div>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <div className="text-white font-bold">{listing.price} تومان</div>
                    </div>
                    <div>
                ...
                <div className="bg-brand-900/10 border border-brand-900/30 rounded-lg p-3 flex items-start gap-2">
                  ...
                  <p className="text-[11px] text-gray-400 leading-relaxed">وجه شما تا تایید نهایی انتقال در حساب واسط پلتفرم بلوکه می‌ماند.</p>
                </div>
              </div>
              <div className="flex gap-3">
                <button onClick={() => setStep(1)} className="flex-1 bg-divar-bg border border-divar-border text-white py-3 rounded-lg font-bold transition hover:bg-gray-700">بازگشت</button>
          ...
          {step === 3 && (
            <>
              ...
              <div className="flex gap-3">
                <button onClick={() => setStep(2)} className="flex-1 bg-divar-bg border border-divar-border text-white py-3 rounded-lg font-bold transition hover:bg-gray-700">بازگشت</button>
                <button
                  onClick={handleOtp}
                  disabled={otp.length !== 5}
                  className="flex-1 bg-brand-600 hover:bg-brand-500 disabled:bg-gray-700 disabled:text-gray-500 text-white py-3 rounded-lg font-bold transition"
                >
                  ثبت نهایی
                </button>
              </div>
